...
namespace WebAPI.Controllers
{
    ...
    public class BaseApiController : Controller
    {
        ...
        [ApiExplorerSettings(IgnoreApi = true)]
        public IActionResult GetResponseOnlyResult(object result)
        {
            //return result.Success ? Ok(result) : BadRequest(result);
        ...
        [ApiExplorerSettings(IgnoreApi = true)]
        public IActionResult GetResponseOnlyResultMessage(object result)
        {
        ...
        {
            return Created<T>(new ApiResult<T>
            {
                Success = true,
                Message = message,
                InternalMessage = internalMessage,
        ...
        {
            return Error<T>(new ApiResult<T>
            {
                Success = false,
                Message = message,
                InternalMessage = internalMessage,
    ...
    {
        Task<object> Send(LoginUserQuery loginModel);
    }
}